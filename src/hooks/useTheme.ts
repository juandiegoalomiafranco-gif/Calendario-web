...
const STORAGE_KEY = 'mivida:theme:v1'
...
// Store compartido a nivel de módulo, igual que el resto de hooks de la app.
...
function apply(pref: ThemePreference) {
  ...
  document
    ...
    ?.setAttribute('content', resolved === 'dark' ? '#0d0e11' : '#f4f5f7')
}
