...
const NADO_TECNICA = 'Natación — técnica'
const NADO_RESISTENCIA = 'Natación — resistencia'
...
const DAYS: DayPlan[] = [
  ...
  day('2026-07-17', [
    ...
    flexSlot('2026-07-17-pm', 'fútbol', NADO_RESISTENCIA),
  ]),
  ...
  day('2026-07-21', [easyRun('2026-07-21-am', '5', 5), flexSlot('2026-07-21-pm', 'vóley', NADO_TECNICA)]),
  ...
  day('2026-07-24', [easyRun('2026-07-24-am', '5', 5), flexSlot('2026-07-24-pm', 'fútbol', NADO_RESISTENCIA)]),
  ...
  day('2026-07-28', [easyRun('2026-07-28-am', '6', 6), flexSlot('2026-07-28-pm', 'vóley', NADO_TECNICA)]),
  ...
  day('2026-07-31', [easyRun('2026-07-31-am', '5', 5), flexSlot('2026-07-31-pm', 'fútbol', NADO_RESISTENCIA)]),
  day('2026-08-01', [
    longRun(
      '2026-08-01-am',
      '17–18',
