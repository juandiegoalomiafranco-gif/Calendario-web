...
export const COLORS: Record<ColorKey, ColorStyles> = {
  violet: {
    ...
    solid: 'bg-cat-violet text-on-solid',
  ...
  blue: {
    ...
    solid: 'bg-cat-blue text-on-solid',
    text: 'text-cat-blue',
  ...
  cyan: {
    ...
    solid: 'bg-cat-cyan text-on-solid',
    text: 'text-cat-cyan',
  ...
  teal: {
    ...
    solid: 'bg-cat-teal text-on-solid',
    text: 'text-cat-teal',
  ...
  green: {
    ...
    solid: 'bg-cat-green text-on-solid',
    text: 'text-cat-green',
  ...
  amber: {
    ...
    solid: 'bg-cat-amber text-on-solid',
    text: 'text-cat-amber',
  ...
  orange: {
    ...
    solid: 'bg-cat-orange text-on-solid',
  ...
  rose: {
    ...
    solid: 'bg-cat-rose text-on-solid',
    text: 'text-cat-rose',
  ...
  fuchsia: {
    ...
    solid: 'bg-cat-fuchsia text-on-solid',
  ...
  indigo: {
    ...
    solid: 'bg-cat-indigo text-on-solid',
  ...
  slate: {
    ...
    solid: 'bg-cat-slate text-on-solid',
    text: 'text-cat-slate',
